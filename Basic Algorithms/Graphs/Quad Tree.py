...
class Tree:
    ...
    def divide_to_quads(self, quad):
        ...
        while len(quad.points) > 4:
            ...
            children.append([[quad.borders[0][0], quad.borders[0][1]], [mid_x, mid_y]])
            children.append([[mid_x, quad.borders[0][1]], [quad.borders[1][0], mid_y]])
            children.append([[quad.borders[0][0], mid_y], [mid_x, quad.borders[1][1]]])
            children.append([[mid_x, quad.borders[1][0]], [quad.borders[1][0], quad.borders[1][1]]])
